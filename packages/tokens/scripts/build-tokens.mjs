...
const tokenSets = {
  base: {
    ...
    "--sl-surface-3": "#f3f4f6",
    "--sl-text": "#232323",
    "--sl-text-light": "#4b5563",
    "--sl-muted": "#666666",

    /* Brand */
    "--sl-primary": "#581d74",
    "--sl-primary-hover": "#6b2488",
    "--sl-primary-active": "#4a1862",
    ...
    "--sl-info-soft": "#dbeafe",
    "--sl-danger": "#e91b06",
    "--sl-danger-contrast": "#ffffff",
    "--sl-danger-soft": "#fee2e2",
    "--sl-success": "#398538",
    "--sl-success-contrast": "#ffffff",
    "--sl-success-soft": "#dcfce7",
    "--sl-warning": "#b86b00",
    "--sl-warning-contrast": "#ffffff",
    "--sl-warning-soft": "#fef3c7",

    /* Borders */
    "--sl-border": "#dcdcdc",
    "--sl-border-light": "#e5e7eb",
    "--sl-border-strong": "#9ca3af",
  ...
  themes: {
    dark: {
      ...
      "--sl-surface-3": "#1a2742",
      "--sl-text": "#eef2ff",
      "--sl-text-light": "#cbd5e1",
      "--sl-muted": "#a7b0c2",
      "--sl-border": "#263149",
      "--sl-border-light": "#1e2d45",
      "--sl-border-strong": "#3a4a68",
      "--sl-primary-hover": "#7a2f9c",
      "--sl-primary-active": "#4a1862",
      "--sl-primary-soft": "color-mix(in srgb, var(--sl-primary), var(--sl-surface) 88%)",
      "--sl-secondary-soft": "color-mix(in srgb, var(--sl-secondary), var(--sl-surface) 88%)",
      "--sl-accent-soft": "color-mix(in srgb, var(--sl-accent), var(--sl-surface) 88%)",
      "--sl-info-soft": "color-mix(in srgb, var(--sl-info), var(--sl-surface) 88%)",
      "--sl-danger-soft": "color-mix(in srgb, var(--sl-danger), var(--sl-surface) 88%)",
      "--sl-success-soft": "color-mix(in srgb, var(--sl-success), var(--sl-surface) 88%)",
      "--sl-warning-soft": "color-mix(in srgb, var(--sl-warning), var(--sl-surface) 88%)"
    },
    hc: {
      "--sl-gray-50": "#000",
      "--sl-gray-100": "#1a1a1a",
      ...
      "--sl-surface-3": "#1a1a1a",
      "--sl-text": "#fff",
      "--sl-text-light": "#e6e6e6",
      "--sl-muted": "#fff",
      "--sl-primary": "#fff",
      "--sl-primary-hover": "#fff",
      "--sl-primary-active": "#e6e6e6",
      "--sl-primary-contrast": "#000",
      "--sl-primary-soft": "#333",
      "--sl-secondary": "#fff",
      "--sl-secondary-contrast": "#000",
      "--sl-secondary-soft": "#333",
      "--sl-accent": "#fff",
      "--sl-accent-contrast": "#000",
      "--sl-accent-soft": "#333",
      "--sl-info": "#fff",
      "--sl-info-contrast": "#000",
      "--sl-info-soft": "#333",
      "--sl-danger": "#fff",
      "--sl-danger-contrast": "#000",
      "--sl-danger-soft": "#333",
      "--sl-success": "#fff",
      "--sl-success-contrast": "#000",
      "--sl-success-soft": "#333",
      "--sl-warning": "#fff",
      "--sl-warning-contrast": "#000",
      "--sl-warning-soft": "#333",
      "--sl-border": "#fff",
      "--sl-border-light": "#999",
      "--sl-border-strong": "#fff",
      "--sl-focus": "#fff",
